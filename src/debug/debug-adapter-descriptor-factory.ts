...
export class DebugAdapterDescriptorFactory implements vscode.DebugAdapterDescriptorFactory {
  ...
  public createDebugAdapterDescriptor(_vscSession: vscode.DebugSession, _executable: vscode.DebugAdapterExecutable): vscode.ProviderResult<vscode.DebugAdapterDescriptor> {
